...
Fizemos uma releitura dos dados de chuva de sementes de Melo et al., (2010), questionando: i) Se existe o mesmo padrão entre os fragmentos e o ano nos três níveis de diversidade, ii) Se a superprodução de sementes interfere significativamente na diversidade dos fragmentos, iii) Qual o padrão da acumulação de espécies entre os fragmentos. As hipóteses são i) Que existe o mesmo padrão para as espécies abundantes e raras quanto ao ano, mas não quanto ao fragmento, ii) Há uma relação positiva e significante entre a superprodução e a diversidade das sementes, iii) Que o acumulo é mais rápido nos menores fragmentos. 
...
```{r NMDS_fig, fig.show='asis',  echo=TRUE, warning=FALSE, message=FALSE, collapse=TRUE}
...
ggplot(NMDS_data, aes(MDS1, MDS2, color=cat_frag))+
  geom_point(size=2)+
  labs(color="Classe dos Fragmentos")
...
```{r Alfa_frag, fig.show='asis', collapse=TRUE, message=FALSE, warning=FALSE}
...
ggplot(Div_Alfa, aes(Fragmentos, log(Best_0), fill=Fragmentos))+ 
  geom_jitter(aes(fill=Fragmentos, col=Fragmentos), alpha=0.5) +
  ...
  theme(plot.caption=element_text(size=10,
                                  ...
                                  hjust = 1.0,
                                  vjust = 9.0),
        legend.background = element_rect(fill="gray90"))-> Plot1

ggplot(Div_Alfa, aes(Fragmentos, log(Best_1), fill=Fragmentos))+ 
  geom_jitter(aes(fill=Fragmentos, col=Fragmentos), alpha=0.5) +
  geom_boxplot(alpha=0.3)+
  labs(y="Diversidade Alfa", x="", caption = "Q=1")+
  theme(plot.caption=element_text(size=10,
                                  face ="bold.italic",
                                  hjust = 1.0,
                                  vjust = 9.0),
        legend.background = element_rect(fill="gray90"))-> Plot2
  
ggplot(Div_Alfa, aes(Fragmentos, log(Best_2), fill=Fragmentos))+ 
  geom_jitter(aes(fill=Fragmentos, col=Fragmentos), alpha=0.5) +
  geom_boxplot(alpha=0.3)+
  labs(y="", x="Classes dos Fragmentos", caption = "Q=2")+
  theme(plot.caption=element_text(size=10,
                                  face ="bold.italic",
                                  hjust = 1.0,
                                  vjust = 7.0),
        legend.background = element_rect(fill="gray90"))-> Plot3
        
ggarrange(Plot1, Plot2, Plot3, ncol=1, nrow=3, common.legend = TRUE, legend="bottom") -> Div.Alf.Frag.Fig
Div.Alf.Frag.Fig
```
...
ggplot(Dalf_frag_yr1, aes(x=Fragmentos, y=log(Div_0), fill=Ano))+
  ...
  labs(y="", x=" ", caption = "Q=0")+
    theme(plot.caption=element_text(size=10,
                                  ...
                                  hjust = 1.0,
                                  vjust = 9.0))-> Plot04
ggplot(Dalf_frag_yr1, aes(x=Fragmentos, y=log(Div_1), fill=Ano))+
  geom_boxplot(notch = T, alpha=0.3)+
  labs(y="Diversidade Alfa", x=" ", caption = "Q=1")+
    theme(plot.caption=element_text(size=10,
                                  face ="bold.italic",
                                  hjust = 1.0,
                                  vjust = 9.0))-> Plot05
ggplot(Dalf_frag_yr1, aes(x=Fragmentos, y=log(Div_2), fill=Ano))+
  geom_boxplot(notch = T, alpha=0.3)+
  labs(y="", x="Classe de Fragmentos", caption = "Q=2")+
  theme(plot.caption=element_text(size=10,
                                  face ="bold.italic",
                                  hjust = 1.0,
                                  vjust = 9.0))-> Plot06
...
Para verificar a interação entre as variáveis, decidímos contruir modelos lineares generalizados para cada diversidade. Devido aos diversos tratamentos, reduzimos as comunidades filtrando a sua origem e tipo de dispersão. Desse modo, obtemos 4 comunidades com sementes: Dispersadas e abióticas, Dispersadas e zoocóricas, Não dispersadas e abióticas e Não dispersadas e zoocóricas.
...
Encontramos que para as sementes abióticas tanto de origem dispersada quanto local, o ano e o fragmento não apresentam qualquer mudança significativa na variável resposta. Esse padrão também foi encontrado para as sementes zoocóricas não dispersadas. A única comunidade que se mostrou diferente com o glm `m_d_zoo_0` foi a das sementes zoocóricas dispersadas, na qual o fragmento médio teve um aumento da diversidade 0 em relação ao fragmento controle. Ainda, a interação entre o ano e o fragmento mostrou que houve uma diminuição significativa da riqueza no ano de 2007 para os fragmentos médio e pequeno em comparação com o ano de 2006. Entretanto, quando olhamos essa mesma comunidade usando a família binomial negativa `m_d_zoo_0_1` que lida melhor com a superdispersão, encontramos a ausência de interações significativas. 

```{r}
#Grafico dos Fragmentos
ggplot(com_d_zoo, aes(Fragmentos, Div_0, fill=Fragmentos))+ 
  geom_jitter(aes(fill=Fragmentos, col=Fragmentos), alpha=0.5) +
  geom_boxplot(alpha=0.3)+
  labs(y="log da Diversidade", x="Classe de Fragmentos", caption = "Q=0")+
  theme(plot.caption=element_text(size=10,
                                  face ="bold.italic",
                                  hjust = 1.0,
                                  vjust = 9.0))
...
Os resultados são diferentes quando comparamos com os resultados obtidos na diversidade 0. Aqui, as sementes não dispersadas tanto zoocóricas quanto abióticas não apresentaram qualquer mudança significativa na diversidade 1 (mais sensível as espécies raras). As sementes dispersadas abióticas apresentaram um aumento da diversidade sensível as espécies raras nos fragmentos médio e pequeno quando comparado ao fragmento controle. Isso pode ser devido a espécies que outrotra não estavam ali e, com a fragmentação, passaram a ocupar o local, sendo encaradas como raras pelo modelo. As sementes dispersadas zoocóricas apresentaram uma diferença significativa no tamanho médio quando comparado ao tamanho controle, com o tamanho médio contendo diversidade de espécies raras maior que o controle. A interação das variáveis apresentou-se significativa apenas para o tamanho médio. Ele contém menos diversidade quando comparado ao tamanho médio no ano de 2006, muito possivelmente devido a reprodução supraanual.

```{r, warning=FALSE, message=FALSE}
#Grafico dos Fragmentos
#dispersada abio
ggplot(com_d_abio, aes(Fragmentos, log(Div_1+1), fill=Fragmentos))+ 
  geom_jitter(aes(fill=Fragmentos, col=Fragmentos), alpha=0.5) +
  geom_boxplot(alpha=0.3)+
  labs(y="log da Diversidade", x="Classe de Fragmentos", caption = "Q=1")+
  theme(plot.caption=element_text(size=10,
                                  face ="bold.italic",
                                  hjust = 1.0,
                                  vjust = 9.0))
#dispersada zoo
ggplot(com_d_zoo, aes(Fragmentos, log(Div_1+1), fill=Fragmentos))+ 
  geom_jitter(aes(fill=Fragmentos, col=Fragmentos), alpha=0.5) +
  geom_boxplot(alpha=0.3)+
  labs(y="log da Diversidade", x="Classe de Fragmentos", caption = "Q=1")+
  theme(plot.caption=element_text(size=10,
...
Agora os modelos com Diversidade_2
```{r, echo=TRUE, warning=FALSE, message=FALSE, collapse=TRUE}
#glm
...
#Grafico dos Fragmentos
#dispersada abio
ggplot(com_d_abio, aes(Fragmentos, log(Div_2+1), fill=Fragmentos))+ 
  geom_jitter(aes(fill=Fragmentos, col=Fragmentos), alpha=0.5) +
  geom_boxplot(alpha=0.3)+
  labs(y="log da Diversidade", x="Classe de Fragmentos", caption = "Q=2")+
  theme(plot.caption=element_text(size=10,
                                  face ="bold.italic",
                                  hjust = 1.0,
                                  vjust = 9.0))
#dispersada zoo
ggplot(com_d_zoo, aes(Fragmentos, log(Div_2+1), fill=Fragmentos))+ 
  geom_jitter(aes(fill=Fragmentos, col=Fragmentos), alpha=0.5) +
  geom_boxplot(alpha=0.3)+
  labs(y="log da Diversidade", x="Classe de Fragmentos", caption = "Q=2")+
  theme(plot.caption=element_text(size=10,
...
Agora vamos para os gráficos com as variáveis independentes juntas.

```{r, fig.show='asis', collapse=TRUE, message=FALSE, warning=FALSE}
#Gráfico para a Diversidade 0
ggplot(com_d_abio, aes(x=Fragmentos, y=log10(Div_0+1), fill=Ano))+
  geom_jitter(aes(fill=Ano, col=Fragmentos), alpha=0.5) +
  geom_boxplot(alpha=0.3)+
  labs(title="Sementes Abióticas Dispersadas", y="Log da Diversidade", x="Fragmentos", caption = "Q=0")+
  theme(plot.caption=element_text(size=10,
                                  face ="bold.italic",
                                  hjust = 1.0,
                                  vjust = 9.0))-> P8
ggplot(com_d_zoo, aes(x=Fragmentos, y=log10(Div_0+1), fill=Ano))+
  geom_jitter(aes(fill=Ano, col=Fragmentos), alpha=0.5) +
  geom_boxplot(alpha=0.3)+
  labs(title="Sementes Zoocóricas Dispersadas", y="Log da Diversidade", x="Fragmentos", caption = "Q=0")+
  theme(plot.caption=element_text(size=10,
                                  face ="bold.italic",
                                  hjust = 1.0,
                                  vjust = 9.0))-> P9
ggplot(com_nd_abio, aes(x=Fragmentos, y=log10(Div_0+1), fill=Ano))+
  geom_jitter(aes(fill=Ano, col=Fragmentos), alpha=0.5) +
  geom_boxplot(alpha=0.3)+
  labs(title="Sementes Abióticas Não Dispersadas", y="Log da Diversidade", x="Fragmentos", caption = "Q=0")+
  theme(plot.caption=element_text(size=10,
                                  face ="bold.italic",
                                  hjust = 1.0,
                                  vjust = 9.0))-> P10
ggplot(com_nd_zoo, aes(x=Fragmentos, y=log10(Div_0+1), fill=Ano))+
  geom_jitter(aes(fill=Ano, col=Fragmentos), alpha=0.5) +
  geom_boxplot(alpha=0.3)+
  labs(title="Sementes Zoocóricas Não Dispersadas", y="Log da Diversidade", x="Fragmentos", caption = "Q=0")+
  theme(plot.caption=element_text(size=10,
                                  face ="bold.italic",
                                  hjust = 1.0,
                                  vjust = 9.0))-> P11
...
ggarrange(P8, P9, P10, P11, ncol=2, nrow=2, common.legend = TRUE, legend="bottom") -> Imagem3
Imagem3

#Gráfico para a Diversidade 1
ggplot(com_d_abio, aes(x=Fragmentos, y=log10(Div_1+1), fill=Ano))+
  geom_jitter(aes(fill=Ano, col=Fragmentos), alpha=0.5) +
  geom_boxplot(alpha=0.3)+
  labs(title="Sementes Abióticas Dispersadas", y="Log da Diversidade", x="Fragmentos", caption = "Q=1")+
  theme(plot.caption=element_text(size=10,
                                  face ="bold.italic",
                                  hjust = 1.0,
                                  vjust = 9.0))-> P12
ggplot(com_d_zoo, aes(x=Fragmentos, y=log10(Div_1+1), fill=Ano))+
  geom_jitter(aes(fill=Ano, col=Fragmentos), alpha=0.5) +
  geom_boxplot(alpha=0.3)+
  labs(title="Sementes Zoocóricas Dispersadas", y="Log da Diversidade", x="Fragmentos", caption = "Q=1")+
  theme(plot.caption=element_text(size=10,
                                  face ="bold.italic",
                                  hjust = 1.0,
                                  vjust = 9.0))-> P13
ggplot(com_nd_abio, aes(x=Fragmentos, y=log10(Div_1+1), fill=Ano))+
  geom_jitter(aes(fill=Ano, col=Fragmentos), alpha=0.5) +
  geom_boxplot(alpha=0.3)+
  labs(title="Sementes Abióticas Não Dispersadas", y="Log da Diversidade", x="Fragmentos", caption = "Q=1")+
  theme(plot.caption=element_text(size=10,
                                  face ="bold.italic",
                                  hjust = 1.0,
                                  vjust = 9.0))-> P14
ggplot(com_nd_zoo, aes(x=Fragmentos, y=log10(Div_1+1), fill=Ano))+
  geom_jitter(aes(fill=Ano, col=Fragmentos), alpha=0.5) +
  geom_boxplot(alpha=0.3)+
  labs(title="Sementes Zoocóricas Não Dispersadas", y="Log da Diversidade", x="Fragmentos", caption = "Q=1")+
  theme(plot.caption=element_text(size=10,
                                  face ="bold.italic",
                                  hjust = 1.0,
                                  vjust = 9.0))-> P15

ggarrange(P12, P13, P14, P15, ncol=2, nrow=2, common.legend = TRUE, legend="bottom") -> Imagem4
Imagem4

#Gráfico para a Diversidade 2
ggplot(com_d_abio, aes(x=Fragmentos, y=log10(Div_2+1), fill=Ano))+
  geom_jitter(aes(fill=Ano, col=Fragmentos), alpha=0.5) +
  geom_boxplot(alpha=0.3)+
  labs(title="Sementes Abióticas Dispersadas", y="Log da Diversidade", x="Fragmentos", caption = "Q=2")+
  theme(plot.caption=element_text(size=10,
                                  face ="bold.italic",
                                  hjust = 1.0,
                                  vjust = 9.0))-> P16
ggplot(com_d_zoo, aes(x=Fragmentos, y=log10(Div_2+1), fill=Ano))+
  geom_jitter(aes(fill=Ano, col=Fragmentos), alpha=0.5) +
  geom_boxplot(alpha=0.3)+
  labs(title="Sementes Zoocóricas Dispersadas", y="Log da Diversidade", x="Fragmentos", caption = "Q=2")+
  theme(plot.caption=element_text(size=10,
                                  face ="bold.italic",
                                  hjust = 1.0,
                                  vjust = 9.0))-> P17
ggplot(com_nd_abio, aes(x=Fragmentos, y=log10(Div_2+1), fill=Ano))+
  geom_jitter(aes(fill=Ano, col=Fragmentos), alpha=0.5) +
  geom_boxplot(alpha=0.3)+
  labs(title="Sementes Abióticas Não Dispersadas", y="Log da Diversidade", x="Fragmentos", caption = "Q=2")+
  theme(plot.caption=element_text(size=10,
                                  face ="bold.italic",
                                  hjust = 1.0,
                                  vjust = 9.0))-> P18
ggplot(com_nd_zoo, aes(x=Fragmentos, y=log10(Div_2+1), fill=Ano))+
  geom_jitter(aes(fill=Ano, col=Fragmentos), alpha=0.5) +
  geom_boxplot(alpha=0.3)+
  labs(title="Sementes Zoocóricas Não Dispersadas", y="Log da Diversidade", x="Fragmentos", caption = "Q=2")+
  theme(plot.caption=element_text(size=10,
                                  face ="bold.italic",
                                  hjust = 1.0,
                                  vjust = 9.0))-> P19

ggarrange(P16, P17, P18, P19, ncol=2, nrow=2, common.legend = TRUE, legend="bottom") -> Imagem5
Imagem5
