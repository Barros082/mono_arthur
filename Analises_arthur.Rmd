...
### *Abundância versus Anos do experimento e o Tamanho dos Fragmentos*

```{r Abund_Ano_Frag, warning=FALSE, message=FALSE, fig.align='center'}
ggplot(Dalf1, aes(frag_cat, log(abund), fill=yr))+ 
  geom_jitter(aes(fill=yr, col=frag_cat), alpha=0.5) +
  geom_boxplot(alpha=0.3)+
  labs(y="log(Abundância)", x="Tamanho dos Fragmentos")+
  scale_fill_discrete(name="Anos do experimento", 
                      labels=c("2006", "2007"))+
...
library(sjPlot)
tab_model(m_d_abio_0, m_d_zoo_0, m_nd_abio_0, m_nd_zoo_0, auto.label = FALSE, show.ci = FALSE, file = "Tab_div_0.odt", dv.labels = c("Sementes Dispersada Abiotica", "Sementes Dispersada Zoocorica", "Sementes Locais Abioticas", "Sementes Locais Zoocoricas"))
...
tab_model(glm_d_abio_1, glm_d_zoo_1, glm_nd_abio_1, glm_nd_zoo_1, auto.label = FALSE, show.ci = FALSE,
          file = "Tab_div_1.odt", dv.labels = c("Sementes Dispersada Abiotica",
                                                "Sementes Dispersada Zoocorica",
                                                "Sementes Locais Abioticas",
                                                "Sementes Locais Zoocoricas"))

```

Os resultados são diferentes quando comparamos com os resultados obtidos na diversidade 0. Aqui, as sementes não dispersadas tanto zoocóricas quanto abióticas não apresentaram qualquer mudança significativa na diversidade 1 (mais sensível as espécies comuns). As sementes dispersadas abióticas apresentaram um aumento da diversidade sensível as espécies comuns nos fragmentos médio e pequeno quando comparado ao fragmento controle. As sementes dispersadas zoocóricas apresentaram uma diferença significativa no tamanho médio quando comparado ao tamanho controle, com o tamanho médio contendo diversidade de espécies comuns maior que o controle. A interação das variáveis apresentou-se significativa apenas para o tamanho médio.
...
library(sjPlot)
tab_model(glm_d_abio_2, glm_d_zoo_2, glm_nd_abio_2, glm_nd_zoo_2, auto.label = FALSE, show.ci = FALSE,
          file = "Tab_div_2.odt", dv.labels = c("Sementes Dispersada Abiotica",
                                                "Sementes Dispersada Zoocorica",
                                                "Sementes Locais Abioticas",
                                                "Sementes Locais Zoocoricas"))
...
ggplot(com_d_abio, aes(x=as.factor(Fragmentos), y=log10(Div_0+1), group=Ano, col=Ano))+
  ...
  scale_color_discrete(name="Anos do experimento",
                       labels=c("2006", "2007"))+
  scale_x_discrete(labels = c("Control" = "Contínuo",  "Large"="Grande", 
                              "Medium"="Médio", "Small"="Pequeno"))+
  annotate(geom = "text", x=1, y=0.6, label="A)",
           color="black")->d_abio_0
ggplot(com_d_abio, aes(x=as.factor(Fragmentos), y=log10(Div_1+1), group=Ano, col=Ano))+
  ...
  scale_x_discrete(labels = c("Control" = "Contínuo",  "Large"="Grande", 
                              "Medium"="Médio", "Small"="Pequeno"))+
  annotate(geom = "text", x=1, y=0.6, label="B)",
           color="black")->d_abio_1
ggplot(com_d_abio, aes(x=as.factor(Fragmentos), y=log10(Div_2+1), group=Ano, col=Ano))+
  ...
  scale_x_discrete(labels = c("Control" = "Contínuo",  "Large"="Grande",
                              "Medium"="Médio", "Small"="Pequeno"))+
  annotate(geom = "text", x=1, y=0.6, label="C)",
           color="black")->d_abio_2
...
ggplot(com_nd_abio, aes(x=as.factor(Fragmentos), y=log10(Div_0+1), group=Ano, col=Ano))+
  ...
  scale_x_discrete(labels = c("Control" = "Contínuo",  "Large"="Grande",
                              "Medium"="Médio", "Small"="Pequeno"))+
  annotate(geom = "text", x=1, y=0.6, label="G)",
           color="black")->nd_abio_0
ggplot(com_nd_abio, aes(x=as.factor(Fragmentos), y=log10(Div_1+1), group=Ano, col=Ano))+
  ...
  scale_x_discrete(labels = c("Control" = "Contínuo",  "Large"="Grande",
                              "Medium"="Médio", "Small"="Pequeno"))+
  annotate(geom = "text", x=1, y=0.6, label="H)",
           color="black")->nd_abio_1
ggplot(com_nd_abio, aes(x=as.factor(Fragmentos), y=log10(Div_2+1), group=Ano, col=Ano))+
  ...
  scale_x_discrete(labels = c("Control" = "Contínuo",  "Large"="Grande",
                              "Medium"="Médio", "Small"="Pequeno"))+
  annotate(geom = "text", x=1, y=0.6, label="I)",
           color="black")->nd_abio_2
...
ggplot(com_d_zoo, aes(x=as.factor(Fragmentos), y=log10(Div_0+1), group=Ano, col=Ano))+
  ...
  scale_x_discrete(labels = c("Control" = "Contínuo",  "Large"="Grande",
                              "Medium"="Médio", "Small"="Pequeno"))+
  annotate(geom = "text", x=1, y=1.35, label="D)",
           color="black")->d_zoo_0
...
ggplot(com_nd_zoo, aes(x=as.factor(Fragmentos), y=log10(Div_0+1), group=Ano, col=Ano))+
  ...
  scale_x_discrete(labels = c("Control" = "Contínuo",  "Large"="Grande",
                              "Medium"="Médio", "Small"="Pequeno"))+
  annotate(geom = "text", x=1, y=0.95, label="J)",
           color="black")->nd_zoo_0
ggplot(com_nd_zoo, aes(x=as.factor(Fragmentos), y=log10(Div_1+1), group=Ano, col=Ano))+
  ...
  scale_x_discrete(labels = c("Control" = "Contínuo",  "Large"="Grande",
                              "Medium"="Médio", "Small"="Pequeno"))+
  annotate(geom = "text", x=1, y=0.7, label="K)",
           color="black")->nd_zoo_1
ggplot(com_nd_zoo, aes(x=as.factor(Fragmentos), y=log10(Div_2+1), group=Ano, col=Ano))+
  ...
  scale_x_discrete(labels = c("Control" = "Contínuo",  "Large"="Grande",
                              "Medium"="Médio", "Small"="Pequeno"))+
  annotate(geom = "text", x=1, y=0.65, label="L)",
           color="black")->nd_zoo_2
...
```{r Curva_Acum_geral, fig.align='center', warning=FALSE, message=FALSE, error=FALSE}
seed_rain2$yr<-as.factor(seed_rain2$yr)
...
#ggplot
ggplot(data_cds, aes(as.factor(area), riqPeqGrande, group=1))+
  geom_line(col="#9966FF")+
  geom_point(aes(size=log(as.numeric(data_cds$hectares))), col="#9966FF", alpha=0.5)+
  geom_line(aes(as.factor(area), riqGrandPeq, group=1), col="#CC3366")+
  geom_point(aes(as.factor(area), riqGrandPeq, group=1, size=log(rev(as.numeric(data_cds$hectares)))), col="#CC3366",
             alpha=0.5)+
  scale_size_continuous(range=c(1,8), name = "Hectares",
                        breaks = c(2, 4, 6, 8),
                        labels = c("2"="Pequeno",
                        "4"="Médio",
                        "6"="Grande",
...
```{r Curva_Accum_anos, fig.align='center', warning=FALSE, message=FALSE, error=FALSE, fig.dim = c(8, 8)}
seed_rain2 %>% 
  group_by(yr, site) %>% 
...
p21<-ggplot(data_t06, aes(as.factor(area), riq_t06_desc, group=1))+
  geom_line(col="#9966FF")+
  geom_point(aes(size=log(as.numeric(data_t06$hectares))), col="#9966FF", alpha=0.5)+
  geom_line(aes(as.factor(area), riq_t06, group=1), col="#CC3366")+
  geom_point(aes(as.factor(area), riq_t06, group=1, size=log(rev(as.numeric(data_t06$hectares)))), col="#CC3366",
             alpha=0.5)+
  scale_size_continuous(range=c(1,8), name = "Hectares",
                        breaks = c(2, 4, 6, 8),
                        labels = c("2"="Pequeno",
...
p22<-ggplot(data_t07, aes(as.factor(area), riq_t07_desc, group=1))+
  geom_line(col="#9966FF")+
  geom_point(aes(size=log(as.numeric(data_t07$hectares))), col="#9966FF", alpha=0.5)+
  geom_line(aes(as.factor(area), riq_t07, group=1), col="#CC3366")+
  geom_point(aes(as.factor(area), riq_t07, group=1, size=log(rev(as.numeric(data_t07$hectares)))), col="#CC3366",
             alpha=0.5)+
  scale_size_continuous(range=c(1,8), name = "Hectares",
                        breaks = c(2, 4, 6, 8),
                        labels = c("2"="Pequeno",
...
annotate_figure(Imagem6,
                left = text_grob("Número de espécies acumuladas", rot = 90, size = 14),
                bottom = text_grob("Área amostrada (m²)", size = 14))
```
